...
export default function PaymentProcessingEmail({ variables }: Props) {
  return (
    <Html>
      <Body style={{ backgroundColor: "#ffffff", fontFamily: "Arial, sans-serif" }}>
        ...
        <Container style={{ padding: "32px" }}>
          ...
          <Text style={{ fontSize: "16px", color: "#0D2137" }}>
            Your PSSF benefits payment for {sub("[case_type_label]", variables)} (Ref:{" "}
            {sub("[case_reference]", variables)}) is currently being processed.
          </Text>
          <Text style={{ fontSize: "16px", color: "#0D2137" }}>
            We will notify you once the payment has been completed.
          </Text>
          <Button

...
export default function CaseRejectedEmail({ variables }: Props) {
  return (
    <Html>
      <Body style={{ backgroundColor: "#ffffff", fontFamily: "Arial, sans-serif" }}>
        ...
        <Container style={{ padding: "32px" }}>
          ...
          <Text style={{ fontSize: "16px", color: "#0D2137" }}>
            We regret to inform you that your {sub("[case_type_label]", variables)} (Ref:{" "}
            {sub("[case_reference]", variables)}) has been rejected.
          </Text>
          <Text style={{ fontSize: "16px", color: "#0D2137" }}>
            <strong>Reason:</strong> {sub("[rejection_reason]", variables)}
          </Text>
          <Text style={{ fontSize: "16px", color: "#0D2137" }}>
            Please contact PSSF for further guidance on how to proceed.
          </Text>
          <Button

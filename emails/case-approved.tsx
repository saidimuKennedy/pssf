...
export default function CaseApprovedEmail({ variables }: Props) {
  return (
    <Html>
      <Body style={{ backgroundColor: "#ffffff", fontFamily: "Arial, sans-serif" }}>
        ...
        <Container style={{ padding: "32px" }}>
          ...
          <Text style={{ fontSize: "16px", color: "#0D2137" }}>
            We are pleased to inform you that your {sub("[case_type_label]", variables)} (Ref:{" "}
            {sub("[case_reference]", variables)}) has been approved.
          </Text>
          <Text style={{ fontSize: "16px", color: "#0D2137" }}>
            <strong>Approved on:</strong> {sub("[approved_at]", variables)}
          </Text>
          <Text style={{ fontSize: "16px", color: "#0D2137" }}>
            You will receive further updates on the next steps.
          </Text>
          <Button

  ...
  return (
    <div className="max-w-xl mx-auto space-y-8">
      ...
      <div className="border rounded p-4 text-sm space-y-1">
        <p><strong>Bank:</strong> {String(fd.bank_name)} — {String(fd.bank_account_number)} ({String(fd.bank_branch)})</p>
        <p><strong>Leaving:</strong> {String(fd.date_of_leaving)} — {String(fd.reason_for_leaving)}</p>
      ...
      <Button onClick={save} className="w-full bg-[#7C3AED] text-white">Continue to Submit</Button>
    </div>
  )
}

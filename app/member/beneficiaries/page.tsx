  ...
  async function onSubmit(values: FormValues) {
    ...
    try {
      ...
      if (!validateRes.ok || !validateData.matched) {
        setApiError(
          "We could not find a record matching your details. Please check your National ID number and year of birth and try again."
        )
        return
      }
    ...
    <div className="max-w-xl mx-auto space-y-8">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">
          Enter your PSSF-registered National ID and year of birth to begin beneficiary nomination.
        </p>
      </div>
